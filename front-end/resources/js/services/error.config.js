    ...
    function getRoutes() {
      return [{
        ...
        config: {
          ...
          '<br>' +
          '<p>The page you requested could not be access, either contact your webmaster or log-in to your account. Use your browsers <b>Back</b> button to navigate to the page you have prevously come from</p>' +
          '<p><b>Or you could just press this neat little button:</b></p>' +
          '<a ui-sref="primary" class="btn btn-large btn-info"><i class="icon-home icon-white"></i> Take Me Home</a>' +
        '</div>'
        }
